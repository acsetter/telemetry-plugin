...
openssl_md_meth_names = None # (!) real value is "frozenset({'sm3', 'blake2s', 'sha384', 'sha512_256', 'sha512_224', 'sha512', 'ripemd160', 'md5', 'sha224', 'sha3_224', 'blake2b', 'sha3_384', 'md5-sha1', 'md4', 'shake_128', 'sha256', 'sha1', 'sha3_256', 'sha3_512', 'mdc2', 'shake_256', 'whirlpool'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002D68231E3D0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002D68231E3D0>, origin='C:\\\\BuildAgent\\\\system\\\\.persistent_cache\\\\pythons\\\\python38\\\\DLLs\\\\_hashlib.pyd')"
